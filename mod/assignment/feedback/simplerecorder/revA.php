...
<object classid="CLSID:B2EC94AF-4716-4300-824A-3314BF23664A" width=803 height=140>
	<param name="src" value="<?php echo preg_replace('/[^\/]*\.php/', '', $_SERVER['SCRIPT_NAME']); ?>feedback/simplerecorder/LLAudio2.revlet"/>
	...
	<embed type="application/x-revolution"
		src="<?php echo preg_replace('/[^\/]*\.php/', '', $_SERVER['SCRIPT_NAME']); ?>feedback/simplerecorder/LLAudio2.revlet"
