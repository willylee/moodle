...
<div <?php if (!$flag) { ?>id="<?php echo ((isset($qmodpluginID) && $qmodpluginID) ? $modpluginID : 'plugin'); ?>" style="display:none"
...
<object classid="CLSID:B2EC94AF-4716-4300-824A-3314BF23664A" width=803 height=140>
	<param name="src" value="<?php //echo preg_replace('/[^\/]*\.php/', '', $_SERVER['SCRIPT_NAME']);
                                       echo $CFG->wwwroot; ?>/mod/assignment/feedback/player/LLFeedbackPlayer.revlet"/>
