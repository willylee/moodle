 ...
 **/
    ...
    add_to_log($course->id, "languagelesson", "view all", "index.php?id=$course->id", "");
...
/// Print the list of instances (your module will probably extend this)
    ...
    $strdeadline  = get_string("deadline", "languagelesson");
    $strweek  = get_string("week");
    $strtopic  = get_string("topic");
    $strnodeadline = get_string("nodeadline", "languagelesson");
    $table = new stdClass;
    ...
    foreach ($lessons as $lesson) {
        ...
        if ($course->format == "weeks" or $course->format == "topics") {
            if (has_capability('mod/languagelesson:manage', $context)) {
                ...
                $grade_value = 0;
                if ($return = languagelesson_get_user_grades($lesson, $USER->id)) {
