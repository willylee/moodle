...
$string['coursefiledisplay_default'] = 'Default display option for files';
$string['coursefiledisplay_default_help'] = 'This setting determines the default display option for new files added to the course. It can be used to override the system-wide default.';
